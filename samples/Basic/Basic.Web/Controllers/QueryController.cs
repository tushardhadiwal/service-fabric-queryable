...
namespace Basic.Web.Controllers
{
	public class QueryController : QueryableController
	{
        ...
        [HttpDelete]
		[Route("query/{application}/{service}/{collection}")]
		public Task<IActionResult> Delete(string application, string service, string collection, [FromBody] ValueViewModel[] obj)
		{
	    ...
	    [HttpPost]
        [Route("query/{application}/{service}/{collection}")]
	    public Task<IActionResult> Add(string application, string service, string collection, [FromBody] ValueViewModel[] obj)
	    {
        ...
        [HttpPut]
	    [Route("query/{application}/{service}/{collection}")]
	    public Task<IActionResult> Update(string application, string service, string collection, [FromBody] ValueViewModel[] obj)
	    {
